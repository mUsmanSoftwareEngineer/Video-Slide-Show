package vaapps.photoslideshow.photovideomaker.song;
...
public class SongGalleryActivity extends AppCompatActivity implements MarkerView.MarkerListener, WaveformView.WaveformListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AdsManagerQ.getInstance().createInterstitialstaticAd(SongGalleryActivity.this, getResources().getString(R.string.staticinterstitialid));
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            SongGalleryActivity.this.requestPermissions(new String[]{"android.permission.CAMERA", "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE"}, 100);
        }

        layout = findViewById(R.id.adLayout);
        mShimmerViewContainer = findViewById(R.id.shimmer_view_container);
        Log.d("7247check", "banner");
        if (AdsUtils.isNetworkAvailabel(SongGalleryActivity.this)) {
            Log.i("7247check", "banner");

            AdsManagerQ.loadbannerAd(SongGalleryActivity.this, mShimmerViewContainer, layout);
        ...
        toolbar_music = (LinearLayout) findViewById(R.id.toolbar_music);
        setLay();
    ...
    public void setTV(){
        ...
        if (!AdManager.isloadFbMAXAd) {
            ...
            AdManager.maxBanner(SongGalleryActivity.this, adContainer);
    ...
    void setLay(){
        ...
        toolbar_music.setLayoutParams(paramsTop);
        ...
        backimg_music.setLayoutParams(paramsMenu);
        done_music.setLayoutParams(paramsMenu);
    }
    ...
    void loadGui() {
        ...
        backimg_music.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                onBackPressed();
            }
        ...
        done_music.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (flagsong) {
                    onSave();
...
//        ProgressDialog pDialog;
        ...
        protected void onPreExecute() {
            super.onPreExecute();
//            pDialog = new ProgressDialog(SongGalleryActivity.this);
