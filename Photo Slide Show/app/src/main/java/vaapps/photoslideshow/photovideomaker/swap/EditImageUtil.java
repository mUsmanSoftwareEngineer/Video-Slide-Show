...
public class EditImageUtil {
	public static final String FOLDER_NAME = "slideshoweditor";
...
//		File aviaryFolder = new File(KessiApplication.getInstance().getExternalFilesDir(DIRECTORY_DOWNLOADS), FOLDER_NAME);
