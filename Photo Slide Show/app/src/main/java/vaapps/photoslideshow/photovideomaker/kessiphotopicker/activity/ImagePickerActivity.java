package vaapps.photoslideshow.photovideomaker.kessiphotopicker.activity;
...
import vaapps.photoslideshow.photovideomaker.kessiphotopicker.adapter.AlbumAdapter;
import vaapps.photoslideshow.photovideomaker.R;
import vaapps.photoslideshow.photovideomaker.kessiphotopicker.Constants;
import vaapps.photoslideshow.photovideomaker.kessiphotopicker.adapter.ListAlbumAdapter;
import vaapps.photoslideshow.photovideomaker.kessiphotopicker.model.ImageModel;
import vaapps.photoslideshow.photovideomaker.kessiphotopicker.myinterface.IHandler;
import vaapps.photoslideshow.photovideomaker.kessiphotopicker.myinterface.OnAlbum;
import vaapps.photoslideshow.photovideomaker.kessiphotopicker.myinterface.OnListAlbum;
...
public class ImagePickerActivity extends AppCompatActivity implements OnClickListener, OnAlbum, OnListAlbum {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        AdsManagerQ.getInstance().createInterstitialstaticAd(ImagePickerActivity.this, getResources().getString(R.string.staticinterstitialid));
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ImagePickerActivity.this.requestPermissions(new String[]{"android.permission.CAMERA", "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE"}, 100);
        }

        layout = findViewById(R.id.adLayout);
        mShimmerViewContainer = findViewById(R.id.shimmer_view_container);
        Log.d("7247check", "banner");
        if (AdsUtils.isNetworkAvailabel(ImagePickerActivity.this)) {
            Log.i("7247check", "banner");

            AdsManagerQ.loadbannerAd(ImagePickerActivity.this, mShimmerViewContainer, layout);
...
//            Log.e("ImagePickerActivity", "limitImageMax = " + this.limitImageMax);
    ...
    public void setTV(){
        ...
        if (!AdManager.isloadFbMAXAd) {
            ...
            AdManager.maxBanner(ImagePickerActivity.this, adContainer);
