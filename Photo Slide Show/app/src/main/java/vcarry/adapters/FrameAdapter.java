...
public class FrameAdapter extends RecyclerView.Adapter<FrameAdapter.Holder> {
  ...
  /*  private int[] drawable = new int[]{ -1,R.drawable.f_1,
    ...
    private int[] drawable_thumb = new int[]{ R.drawable.none,R.drawable.f_1,
            ...
            R.drawable.f_6, R.drawable.f_7, R.drawable.f_8, R.drawable.f_9,
            R.drawable.f_10};*/
  private int[] drawable = new int[]{ -1,R.drawable.f1,
          R.drawable.f2, R.drawable.f3, R.drawable.f4, R.drawable.f5,
          R.drawable.f6, R.drawable.f7, R.drawable.f8, R.drawable.f9,
          R.drawable.f10,R.drawable.f11,R.drawable.f12,R.drawable.f13,R.drawable.f14,
          R.drawable.f15,R.drawable.f16,R.drawable.f17,R.drawable.f18,R.drawable.f19,
          R.drawable.f20,R.drawable.f21,R.drawable.f21,R.drawable.f22,R.drawable.f23,R.drawable.f24,
          R.drawable.f25,R.drawable.f26,R.drawable.f27,R.drawable.f29,
          ...
          R.drawable.f40,R.drawable.f41,R.drawable.f42,R.drawable.f43,R.drawable.f44,R.drawable.f46,R.drawable.f47};
    ...
    /*
     private int[] drawable_thumb = new int[]{ R.drawable.none,R.drawable.f_1,
             ...
             R.drawable.f_6, R.drawable.f_7, R.drawable.f_8, R.drawable.f_9,
             R.drawable.f_10};*/
    private int[] drawable_thumb = new int[]{ R.drawable.none,R.drawable.f1,
            R.drawable.f2, R.drawable.f3, R.drawable.f4, R.drawable.f5,
            R.drawable.f6, R.drawable.f7, R.drawable.f8, R.drawable.f9,
            R.drawable.f10,R.drawable.f11,R.drawable.f12,R.drawable.f13,R.drawable.f14,
            R.drawable.f15,R.drawable.f16,R.drawable.f17,R.drawable.f18,R.drawable.f19,
