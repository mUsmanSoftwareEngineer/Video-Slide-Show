...
//    public static File mSdCard = KessiApplication.getInstance().getExternalFilesDir(DIRECTORY_DOWNLOADS);

//    public static File mSdCard = new File(Environment.getExternalStorageDirectory().getAbsolutePath());
    public static File APP_DIRECTORY = new File(mSdCard, "Slideshow_SSMaker");
