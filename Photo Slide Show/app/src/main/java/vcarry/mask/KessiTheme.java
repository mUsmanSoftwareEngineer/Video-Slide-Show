...
public enum KessiTheme {
    ...
    LoveMix("LoveMix") {
        ...
        public ArrayList<EFFECT> getTheme() {
            ...
            arrayList.add(EFFECT.LOVE_DOWN);
            arrayList.add(EFFECT.LOVE_DOWNA);
            arrayList.add(EFFECT.LOVE_DOWNB);
            arrayList.add(EFFECT.LOVE_DOWNC);
            return arrayList;
        }
    }, TriMix("TriMix") {
        public ArrayList<EFFECT> getTheme(ArrayList<EFFECT> arrayList) {
        ...
        public ArrayList<EFFECT> getTheme() {
            ArrayList<EFFECT> arrayList = new ArrayList();
            arrayList.add(EFFECT.Down_TRIANGLE);
            arrayList.add(EFFECT.Down_Arrow);
            arrayList.add(EFFECT.Down_TRIANGLEA);
            arrayList.add(EFFECT.Down_TRIANGLEB);
            return arrayList;
        }
    }, SmokeMix("SmokeMix") {
        public ArrayList<EFFECT> getTheme(ArrayList<EFFECT> arrayList) {
        ...
        public ArrayList<EFFECT> getTheme() {
            ArrayList<EFFECT> arrayList = new ArrayList();
            arrayList.add(EFFECT.Smoke);
            arrayList.add(EFFECT.SmokeA);
            arrayList.add(EFFECT.SmokeB);
            arrayList.add(EFFECT.SmokeC);
//            arrayList.add(EFFECT.Bubble);
//            arrayList.add(EFFECT.BubbleB);
//            arrayList.add(EFFECT.Sparkle);
            return arrayList;
        }
    }, ZoomOut("ZoomOut") {
        public ArrayList<EFFECT> getTheme(ArrayList<EFFECT> arrayList) {
        ...
        public ArrayList<EFFECT> getTheme() {
            ArrayList<EFFECT> arrayList = new ArrayList();
            arrayList.add(EFFECT.ZoomOut_Top);
            arrayList.add(EFFECT.ZoomOut_Center);
            arrayList.add(EFFECT.ZoomOut_Bottom);
            return arrayList;
        }
    }, Mixer("Mixer") {
        public ArrayList<EFFECT> getTheme(ArrayList<EFFECT> arrayList) {
...
//        public ArrayList<EFFECT> getTheme() {
//            ArrayList<EFFECT> arrayList = new ArrayList();
//            arrayList.add(EFFECT.Rect_Zoom_In);
//            arrayList.add(EFFECT.Rect_Zoom_Out);
//            return arrayList;
//        }
//    }
